      ...
      <div class="navbar-content">
        <div class="index">
          <NuxtLink to="/" class="index-link">
            ...
            <div class="index-me">
              <p class="index-name caption">Praveen Manchi</p>
        ...
        <div class="links">
          <ul>
            ...
            <li><NuxtLink class="caption" to="/notes">Case Studies</NuxtLink></li>
            <li><NuxtLink class="caption" to="/contact">Contact</NuxtLink></li>
            <li><NuxtLink class="caption" to="/about/moodboard">Moodboard</NuxtLink></li>
          </ul>
        </div>
      </div>
    </div>
